...
CREATE TABLE "TicketPriorities" (
    ...
    CONSTRAINT "TicketPriorities_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "TicketStatuses_name_key" ON "TicketStatuses"("name");

-- CreateIndex
CREATE UNIQUE INDEX "TicketPriorities_name_key" ON "TicketPriorities"("name");
...
-- AddForeignKey
ALTER TABLE "Ticket" ADD CONSTRAINT "Ticket_priorityId_fkey" FOREIGN KEY ("priorityId") REFERENCES "TicketPriorities"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
