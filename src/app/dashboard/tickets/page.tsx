...
const TicketsPage = () => {
  ...
  return (
    <div>
      <h1 className="text-3xl font-semibold mb-4">Ticket Overview</h1>
      <Button onClick={() => {redirect('/tickets/create')}}>Create</Button>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {tickets.map((ticket: any) => (
          <Card key={ticket.id} className="bg-card text-card-foreground shadow-md">
            <CardHeader>
              <CardTitle>
